...
function (angular, _, kbn, $) {
  ...
  module.service('panelHelper', function(timeSrv, $rootScope) {
    ...
    this.getAlertData = function(scope){
      return {
        name: scope.panel.alertName,
        threshold1: scope.panel.threslow,
        threshold2: scope.panel.threshigh,
        target: scope.panel.alertTarget
      };
